...
// use App\Http\Controllers\Components\Diary\DiaryData;
 // No direct access to this file

class DiaryTemplates extends BaseController{

  public static function renderLupoEditor($noheader = true){
...
<script>
var myElement = document.getElementById('overscroller').parentNode;
var topPos = myElement.offsetTop;
document.getElementById('overscroller').scrollTop = topPos;
