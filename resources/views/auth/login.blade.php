...
<body class="align">
  ...
  <div class="grid p-4">
    ...
    <p class="text--center">Not a member? <a href="{{ route('registration')}}">Sign up now</a> <svg class="icon">
        <use xlink:href="#icon-arrow-right"></use>
      </svg></p>

  </div>
  <a href="{{ route('home')}}" class="btn login-btn"><span>Home page</span>  <span><i class="bi-house" role="img" aria-label="Home"></i>
    </span></a>
